...
def upgrade():
    ...
    op.create_table('categoryprioritys',
    ...
    op.create_index(op.f('ix_categoryprioritys_id'), 'categoryprioritys', ['id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['location'], ['factorymaps.id'], name='fk_users_factorymaps_id_location'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('created_date', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_auditlogheaders_users_id_user'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('categoryprioritys_devices',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('category', sa.String(length=100), nullable=True),
    sa.Column('devices', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['category'], ['devices.id'], name='fk_categoryprioritys_devices_devices_category_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['devices'], ['categoryprioritys.id'], name='fk_categoryprioritys_devices_categoryprioritys_devices_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('devicemanageinfos',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('device', sa.String(length=100), nullable=True),
    sa.Column('date', sa.Date(), nullable=False),
    sa.ForeignKeyConstraint(['device'], ['devices.id'], name='fk_devicemanageinfos_devices_id_device'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['device'], ['devices.id'], name='fk_missions_devices_id_device'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('created_date', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_date', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['device'], ['devices.id'], name='fk_userdevicelevels_devices_id_device'),
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_userdevicelevels_users_id_user'),
    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('usershiftinfos',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user', sa.String(length=36), nullable=True),
    sa.Column('shift_date', sa.Date(), nullable=False),
    sa.Column('attend', sa.Boolean(), nullable=True),
    sa.Column('day_or_night', sa.String(length=5), nullable=False),
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_usershiftinfos_users_id_user'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user', 'shift_date', name='uc_usershiftinfos_user_shift_date')
    )
    op.create_index(op.f('ix_usershiftinfos_id'), 'usershiftinfos', ['id'], unique=False)
    ...
    sa.Column('updated_date', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['at_device'], ['devices.id'], name='fk_worker_status_devices_id_at_device'),
    sa.ForeignKeyConstraint(['worker'], ['users.id'], name='fk_worker_status_users_id_worker'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('deviceinfo_chiefs',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user', sa.String(length=36), nullable=True),
    sa.Column('devicemanageinfo', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['devicemanageinfo'], ['devicemanageinfos.id'], name='fk_deviceinfo_chiefs_devicemanageinfos_devicemanageinfo_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_deviceinfo_chiefs_users_user_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('deviceinfo_managers',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user', sa.String(length=36), nullable=True),
    sa.Column('devicemanageinfo', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['devicemanageinfo'], ['devicemanageinfos.id'], name='fk_deviceinfo_managers_devicemanageinfos_devicemanageinfo_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_deviceinfo_managers_users_user_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('deviceinfo_supervisors',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user', sa.String(length=36), nullable=True),
    sa.Column('devicemanageinfo', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['devicemanageinfo'], ['devicemanageinfos.id'], name='fk_deviceinfo_supervisors_devicemanageinfos_devicemanageinfo_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_deviceinfo_supervisors_users_user_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['user'], ['users.id'], name='fk_missions_users_users_user_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('usershiftinfos_devices',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('device', sa.String(length=100), nullable=True),
    sa.Column('usershiftinfo', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['device'], ['devices.id'], name='fk_usershiftinfos_devices_devices_device_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['usershiftinfo'], ['usershiftinfos.id'], name='fk_usershiftinfos_devices_usershiftinfos_usershiftinfo_id', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('categoryprioritys_devices')
    ...
    op.drop_index(op.f('ix_categoryprioritys_id'), table_name='categoryprioritys')
    op.drop_table('categoryprioritys')
    # ### end Alembic commands ###
