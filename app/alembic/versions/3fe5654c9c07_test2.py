...
Revision ID: 3fe5654c9c07
Revises: 
Create Date: 2022-11-23 15:04:59.050047
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['log_header'], ['audit_log_headers.id'], name='fk_log_values_audit_log_headers_id_log_header', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_log_values_id'), 'log_values', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_log_values_id'), table_name='log_values')
