...
Revision ID: 21e7593ba36c
Revises: 
Create Date: 2022-12-03 16:33:19.924538
...
def upgrade() -> None:
    ...
    op.create_table('devices',
                    ...
                    sa.Column('created_date', sa.DateTime(timezone=True), nullable=True),
                    sa.Column('updated_date', sa.DateTime(timezone=True), nullable=True),
                    sa.ForeignKeyConstraint(['workshop'], ['factory_maps.id'],
                                            name='fk_devices_factory_maps_id_workshop'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('users',
                    ...
                    sa.Column('updated_date', sa.DateTime(timezone=True), nullable=True),
                    sa.Column('created_date', sa.DateTime(timezone=True), nullable=True),
                    sa.ForeignKeyConstraint(['at_device'], ['devices.id'],
                                            name='fk_users_devices_id_at_device', ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['shift'], ['shifts.id'], name='fk_users_shifts_id_shift'),
                    sa.ForeignKeyConstraint(['start_position'], ['devices.id'],
                                            name='fk_users_devices_id_start_position', ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['superior'], ['users.badge'], name='fk_users_users_badge_superior'),
                    sa.ForeignKeyConstraint(['workshop'], ['factory_maps.id'],
                                            name='fk_users_factory_maps_id_workshop', ondelete='SET NULL'),
    ...
    op.create_table('whitelist_devices',
                    ...
                    sa.ForeignKeyConstraint(['device'], ['devices.id'],
                                            name='fk_whitelist_devices_devices_id_device', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('audit_log_headers',
                    ...
                    sa.ForeignKeyConstraint(['user'], ['users.badge'],
                                            name='fk_audit_log_headers_users_badge_user', ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('missions',
                    ...
                    sa.Column('updated_date', sa.DateTime(timezone=True), nullable=True),
                    sa.ForeignKeyConstraint(['device'], ['devices.id'],
                                            name='fk_missions_devices_id_device', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['worker'], ['users.badge'],
                                            name='fk_missions_users_badge_worker', ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('user_device_levels',
                    ...
                    sa.Column('updated_date', sa.DateTime(timezone=True), nullable=True),
                    sa.ForeignKeyConstraint(['device'], ['devices.id'],
                                            name='fk_user_device_levels_devices_id_device', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user'], ['users.badge'],
                                            name='fk_user_device_levels_users_badge_user', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('whitelistdevices_users',
                    ...
                    sa.ForeignKeyConstraint(
                        ['user'], ['users.badge'], name='fk_whitelistdevices_users_users_user_badge', onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['whitelistdevice'], ['whitelist_devices.id'],
                                            name='fk_whitelistdevices_users_whitelist_devices_whitelistdevice_id', onupdate='CASCADE', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('mission_events',
                    ...
                    sa.Column('created_date', sa.DateTime(timezone=True), nullable=True),
                    sa.Column('updated_date', sa.DateTime(timezone=True), nullable=True),
                    sa.ForeignKeyConstraint(['mission'], ['missions.id'],
                                            name='fk_mission_events_missions_id_mission', ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('event_id', 'table_name', 'mission',
                                        name='uc_mission_events_event_id_table_name_mission')
                    )
    op.create_table('missions_users',
                    ...
                    sa.Column('mission', sa.Integer(), nullable=True),
                    sa.ForeignKeyConstraint(['mission'], ['missions.id'],
                                            name='fk_missions_users_missions_mission_id', onupdate='CASCADE', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['user'], ['users.badge'], name='fk_missions_users_users_user_badge',
